...
class autoencoder(nn.Module):
    ...
    def __init__(self, input_dim: int = 10000, z_dim: int = 32, gene_set_dim: int = 335, encoder_dim: int = 128,
                 ...
                 dropout_rate: float = 0., reconstruction_network: str = "non-negative",
    ...
    def loss(self, x_raw_tensor, mean_tensor, disp_tensor, pi_tensor):
        #l = self.zinb_loss(x=x_raw_tensor, mean=mean_tensor, disp=disp_tensor, pi=pi_tensor)
        l = self.criterion(pi_tensor, disp_tensor, x_raw_tensor, mean_tensor) 
        return l
